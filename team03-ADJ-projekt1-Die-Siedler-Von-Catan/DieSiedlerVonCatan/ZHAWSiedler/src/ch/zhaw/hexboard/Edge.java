...
final class Edge {
  ...
  /**
   * Checks if the two points are a valid edge on the grid.
   *
   * @param p1 first point
   * @param p2 second point
   * @return true if the two points are a valid edge on the grid .
   */
  ...
  /**
    * Returns the start/End point of the edge.
   */
