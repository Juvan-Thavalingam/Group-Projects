...
public class HexBoard<F, C, E, A> {
  ...
  public void addFieldAnnotation(Point center, Point corner, A data) {
    ...
    if (!annotation.containsKey(annotationPosition)) {
      ...
      annotation.replace(annotationPosition, data);
  ...
  /**
   * Determines whether the field annotation at the specified position exists.
   * @return false, if the field annotation does not exist or the position is not a field
   */
  ...
  /**
   * Determines whether the corner at the specified position exists.
   * @return false, if the corner does not exist or the position is not a corner
   */
  ...
  /**
   * A list defining the fields that are adjacent to the specified corner.
   */
