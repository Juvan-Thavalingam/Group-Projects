...
public class Car implements CarSpecification {
    ...
    /**
     * Current number of completed rounds
     */
    ...
    public void accelerate(PositionVector.Direction acceleration) {
        setVelocity(PositionVector.add(getCurrentVelocity(), acceleration.vector));
    }
    ...
    @Override
    public void move() {
        setPosition(PositionVector.add(getPosition(), getCurrentVelocity()));
    }
     ...
     * @return PositionVector current velocity
     */
    ...
    */
    ...
    /**
     * Get current completed rounds of the car.
     * @return int indicates the number of rounds completed.
     */
    ...
    /**
     * Adds the parameter value to the current round counter.
     * @param round will added to the completed round counter.
     */
    public void addCompletedRound(int round) {
